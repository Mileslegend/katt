      ...
      <div className="container">
        ...
        <div className="column">
          ...
          <h1 className="sub__title">
            Turning your <span className="g-text">adventures</span> into an
            experience for a lifetime
          </h1>
          <p className="text__muted description">
            Allow us to be your compass in the vast world of travel, leading you
            to discover the hidden gems and untamed wonders of Africa. Whether
            you desire thrilling wildlife encounters, soul-stirring landscapes,
            or cultural immersion, our expert team will craft a personalized
          ...
          <div className="group">
            ...
            <div className="row">
              ...
              <div className="details">
                <p className="text__muted">Client</p>
                <h3>Support</h3>
              </div>
            </div>
            {/* End row */}
